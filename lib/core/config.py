...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, default="configs/config_w_3dpw.yaml", help='cfg file path')

    parser.add_argument('--gpu', type=str, default='', help='gpu num')
    # evaluation options
    parser.add_argument('--dataset', type=str, default='3dpw', help='pick from 3dpw, mpii3d')
